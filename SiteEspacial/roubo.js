(window.webpackJsonp = window.webpackJsonp || []).push([[0], Array(517).concat([function(e, t, n) {
    var i = n(39)
      , o = n(138);
    e.exports = function() {
    ...
    e.exports = new o({
        defaults: {
            ...
            getShareURL: function() {
                ...
                return this.isAudible && this.isPrivate() && (e += "/" + this.model.get("secret_token")),
                e
            }
        },
        before: {
            setup: function(e) {
                if (!this.model) {
                    ...
                    0,
                    this.ModelClass = t.ModelClass,
                    i.extend(this, t.props),
                    this.model = this.getModel(e.resource_id, e.resource_type)
                }
            }
        }
    })
    ...
    e.exports = r.extend(s, {
        ...
        setup: function() {
            var e = this.model
              , t = this.model;
            t.imageAttribute,
            this.requiredAttributes = ["kind", t.imageAttribute],
            this.toggleState("fadeIn", !0),
            this.$el.addClass(["sc-artwork", o.getPlaceholderClass(this.model.id), e.stretch ? "image-full" : ""].join(" "))
        },
        renderDecorate: function() {
            var e = a(this);
            e && !o.isDefaultImage(e) ? this.addDeferred(o.load(e).done(function() {
                this.toggleState("fadeIn", !1),
                o.flagCachedImage(e)
            }
...
, function(e, t, n) {
    ...
    (e.exports = function(e, t) {
        ...
        n === i.PLAYLIST ? new o(e,t) : new s(e,t)
    }
    ).getClass = function(e) {
...
, function(e, t, n) {
    (function(t) {
        var i, o, s, r = n(599), a = n(2), l = n(40), u = n(52), c = n(53), d = n(601), h = /default/, p = /^.*\/(\w+)-([-a-z0-9]+)-([a-z0-9]+)\.(jpg|png|gif).*$/i, m = {}, f = [[20, "t20x20"], [50, "t50x50"], [120, "t120x120"], [200, "t200x200"], [500, "t500x500"]], g = ["alt", "class", "height", "src", "title", "width"], v = {
            ...
            markup: function(e, t) {
                var n, i, o, s;
                return e && e.attributes && (e = e.attributes),
                n = t.src || this.urlFrom(e, t.size),
                n = this.isDefaultImage(n) ? null : "url(" + n + ")",
                s = t.placeholderId || e,
                o = t.stretch ? "100%" : t.size + "px",
                i = a.extend({
                    style: {
                        "background-image": n,
                        width: o,
                    ...
                    "aria-role": "img"
                }, a.omit(t, "stretch", "size", "class")),
                d.getMarkup("span", i, v)
            },
            ...
            getPlaceholderUrl: function(e, t) {
                ...
                if (o = y(b.setFormat(e, t))) {
                    ...
                    if (i && s === i)
                        return !1;
                    if (s)
                        return b.setFormat(e, s[0])
                }
                return null
            },
            urlFrom: function(e, t) {
                var n = e && (e.artwork_url || e.avatar_url || e.user && e.user.avatar_url) || "";
                return t && u.isHiDPI && (t *= 2),
                b.isDefaultImage(n) ? n : (n = w(n).replace(/^https?\:\/\//, "//"),
                t ? b.setFormat(n, t) : n)
            },
            ...
            getMainColor: function(e, t) {
                var n, i, o, s = e.data, r = s.length, a = {}, u = 0, c = r / 4;
                for (t = l.clamp(t || 0, 1, c),
                o = 0; o < r; o += 4 * t)
                    a[i = (i = [s[o], s[o + 1], s[o + 2]]).join(",")] = a.hasOwnProperty(i) ? ++a[i] : 1;
                for (i in a)
        ...
        function y(e) {
            ...
            t = e.replace(p, (function(e, t, o, s, r) {
        ...
        function w(e) {
            p.lastIndex = 0;
            var t, n = p.exec(e);
            return n && 1 !== (t = n[3].charCodeAt(0) % 4 + 1) && (e = e.replace("//i1.", "//i" + t + ".")),
            e
        }
        function x(e) {
            m[e.type] || (m[e.type] = {}),
            m[e.type][e.key] |= 1 << e.index
        }
...
, function(e, t, n) {
    ...
    e.exports = d.extend(l, {
        ...
        onIconClick: function(e) {
            var t = this.options
              , n = t.popupSize;
            t.opensPopup && (e.preventDefault(),
            o.centered(e.target.getAttribute("href"), n[0], n[1])),
            i.trigger(r.UI.SHARE_ICON_CLICKED, {
                model: this.model,
    ...
    function f() {
        var e;
        return this.isAudible && (e = this.model.toJSON(),
        encodeURIComponent(["SoundCloud", e.user.username].concat(s.extract(e).slice(0, 4)).join(","))),
        ""
    }
}
, function(e, t, n) {
    (function(t) {
        ...
        e.exports = new r({
            applyTo: function(e) {
                ...
                e.className = ["sc-button", e.className].join(" ").trim(),
                e.events = i.extend({}, e.events, {
            ...
            before: {
                setup: function(e) {
                    this.$el.attr("tabIndex", 0).addClass("sc-button-" + e.size),
                    this.toggleState("icon", e.icon_only).toggleState("visual", e.visual),
                    a.call(this, this.getWindowSize())
                }
            }
        });
        function a(e) {
...
, function(e, t, n) {
    ...
    e.exports = u.extend({
        ...
        states: {
            ...
            emptyWaveform: function(e) {
                this.$el.toggleClass("waveform__empty", e),
                e && this.toggleState("loaded", !0)
            },
            loaded: "loaded"
        },
        element2selector: {
        ...
        setup: function() {
            _.call(this, "on"),
            this.scene = new r,
            this.whenReadyForLayers = o.defer(),
            this.layersAreInserted = !1,
            o.all([this.whenInserted(), c.loadWaveformDataForView(this)]).done(this.whenReadyForLayers.resolve)
        },
        dispose: function() {
            _.call(this, "off")
        },
        renderDecorate: function() {
            this.model.isProcessing() ? this.toggleState("emptyWaveform", !0) : y.call(this) && this.whenInserted().done(k.bind(this)),
            this.whenReadyForLayers.done(w.bind(this))
        },
        teardown: function() {
            this.scene.teardown(),
            this._commentsShowing = !1,
            this.layersAreInserted = !1
        },
        addLayer: function(e, t) {
            var n, o = new a, s = o.el, r = this.scene, l = this.getElement("sceneElement");
            return t = t || {},
            this.addSubview(o),
            r.addLayer(o),
            void 0 === t.at ? l.append(s) : (n = r.getLayers()[t.at]) ? n.$el.before(s) : l.append(s),
            o.initCanvasDimensions(),
            e.filter(i.identity).forEach(o.addNode, o),
            o
        },
    ...
    function w() {
        if (!this.disposed && !this.layersAreInserted) {
            ...
            this.addLayer([[h, i.defaults({
                waveformData: this.waveformData
            }, s)], [f, i.clone(s)], n && !l.touch ? [g, s] : null]),
            n && this.addLayer([[v, i.clone(s)], [m, i.clone(s)]]),
            x.call(this),
            this.toggleState("loaded", !0),
            this.layersAreInserted = !0
        }
    }
    function x() {
        var e;
        !this._commentsShowing && y.call(this) && (e = this.model,
        this.addLayer([[p, {
            sound_id: e.id,
        ...
        this._commentsShowing = !0)
    }
    function k() {
        if (!this.subviews.commentPopover) {
            var e, t = this.model, n = this.el.offsetHeight * (1 - this.options.upperPartHeight);
            (e = new d({
                sound_id: t.id,
                resource_id: t.resource_id,
            ...
            this.addSubview(e, "commentPopover")
        }
    }
}
, function(e, t, n) {
    ...
    e.exports = new i(s,{
        ...
        insidePlayableArea: function(e, t) {
            return !this.hasUnplayableArea() || ("ms" === t && (e = this.msToPx(e)),
            e <= this.getPlayableWidth())
        },
...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports = f.extend(h, d, {
            ...
            events: {
                ...
                "click .visualAudible__artwork, .visualAudible__footer": function(e) {
                    if (this.isBlocked())
                        return;
                    if (t(e.target).closest(".artworkWaveform, .waveform").length)
                        return;
            ...
            setup: function(e) {
                (this.requiredAttributes[e.resource_type] = this.requiredAttributes[e.resource_type] || []).push(this.model.imageAttribute),
                _.call(this, !0),
                this.toggleState("mobile", r.isMobile)
            },
            dispose: function() {
                _.call(this, !1)
            },
            renderDecorate: function() {
                ...
                if (this.toggleState("blocked", e),
                !e) {
                    var t = this.model.hasVisuals && this.model.hasVisuals();
                    k.call(this),
                    b.call(this),
                    t || this.correctLogoColor()
                }
            },
            ...
            toggleBackgroundState: function(e) {
                this.toggleState("background", e),
                this.subviews.visuals && this.subviews.visuals.toggleState("background", e)
            },
            getTemplateData: function(e) {
                return i.extend(e, {
        ...
        function A(e) {
            this._isInsertingWaveform || (this._isInsertingWaveform = !0,
            O.call(this).done(function(t) {
                var n = this.subviews.waveform;
                if (!n || n.model !== e || t !== this.waveformStyle && this.isPlaylist) {
                    this.waveformStyle = t;
                    var i = C.call(this, e, t)
                      , s = !1;
                    i.$el.addClass("hidden g-all-transitions-200"),
                    this.$$("waveform").append(i.render().el),
                    o.fadeOut(n ? n.$el : this.$$("total")).progress((function(e) {
                        !s && e >= .4 && (s = !0,
                        i.$el.removeClass("hidden"))
                    }
                    )).done(function() {
                        S.call(this, i),
                        this._isInsertingWaveform = !1
                    }
                    .bind(this))
                } else
                    this._isInsertingWaveform = !1
        ...
        function S(e) {
            ...
            t && (this.removeSubview(t),
            t._dispose()),
            this.addSubview(e, "waveform")
        }
        function C(e, t) {
        ...
        function P(e) {
            var t = E.call(this);
            this.toggleState("highlight", e),
            t && t.toggleState("hover", e)
        }
        function T(e) {
        ...
        function E() {
            ...
            return e && e instanceof s && (e = e.subviews.waveform),
            e
        }
        function I() {
            var e = t.Deferred();
        ...
        function D(e, n) {
            ...
            return c.isDefaultImage(r) ? i.resolve(l("#000").rgb(), e) : (function(e, n) {
                ...
                if (!this.disposed) {
                    var t, r, a = (e instanceof f ? e.el : e[0]).getBoundingClientRect(), l = o.getBoundingClientRect();
                    t = s.getImageData({
        ...
        function O() {
            var e, n = t.Deferred();
            return this.model.hasVisuals && this.model.hasVisuals() && (e = "default"),
            e ? n.resolve(e) : this.whenReady().done(function() {
                D.call(this, this.$$("waveform")).done(function(t) {
                    var i = "rgb(" + v.getColor("backgroundGradient", "default")[0][1] + ")"
                      , o = l(t).diff(i).brightness;
                    e = o > 190 ? "default" : "inverted",
                    n.resolve(e)
                }
                .bind(this))
            }
    ...
    (function(t) {
        ...
        e.exports = new o({
            ...
            before: {
                ...
                dispose: function() {
                    this.currentSound && this.currentSound.release(),
                    this.currentSound = null
                },
                renderDecorate: function() {
                    s.call(this, !0)
...
, function(e, t) {
    e.exports = {
        format: function(e) {
            ...
            e != e ? "" : e.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
        },
        shorten: function(e) {
            var t;
            return [{
...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports = o.extend({
            ...
            _desiredLength: null,
            _setup: function(e) {
                o.prototype._setup.call(this, e),
                this._desiredLength = Math.max(e.minDisplay, e.maxDisplay) || 1 / 0
            },
            renderDecorate: function() {
            ...
            createListElement: function() {
                ...
                return n.length && !this._listElement && (e = window.document.createElement(this.listTagName),
                this.listClassName && (e.className = this.listClassName),
                n.append(e),
                this.resetElementCache(),
                this._listElement = t(e)),
                this._listElement
            },
            syncItems: function() {
                var e, t = this.getModelsToRender(), n = this.getLength(), i = Math.min(a.call(this), t.length);
                if (this.removeReadMoreView(),
                n < i)
                    for (e = n; e < i; ++e)
                        this.createAndInsertListItemView(t[e], -1);
                else
                    n > i && l.call(this);
            ...
            appendReadMoreView: function() {
                var e, t;
                this.needsReadMoreView() && (e = this.getLength(),
                t = this.getSubviewModel(this.getModelsToRender()[e]),
                this.createAndInsertReadMoreView(t, e))
            },
            ...
            setDisplayedItems: function(e) {
                (e = Math.min(e, this.options.maxDisplay || 1 / 0)) !== this._desiredLength && (this._desiredLength = e,
                this.syncItems())
            },
            _teardown: function() {
                this._listElement && (this._listElement.remove(),
                this._listElement = null),
                o.prototype._teardown.call(this)
            },
            ...
            createAndInsertListItemView: function(e, t) {
                ...
                n.render(),
                this.addListItemToDOM(n, i.isNumber(t) ? t : -1),
                l.call(this)
            },
            ...
            getListItemAttributesString: function(e) {
                ...
                return new s.SafeString((t = a,
                r = [],
                i.each(t, (function(e, t) {
                    n = t + '="',
                    o = [],
                    i.isObject(e) ? i.each(e, (function(e, t) {
                        o.push(t + ":" + e)
                    }
                    )) : o.push(e),
                    r.push(n + o.join(";") + '"')
            ...
            onAdd: function(e, t, n) {
                if (!this.disposed) {
                    ...
                    this.removeReadMoreView(),
                    s && this.createAndInsertListItemView(e, i),
                    this.appendReadMoreView()
                }
            },
            onRemove: function(e, t, n) {
                var i = this.getListItemView(e);
                i && (this.removeReadMoreView(),
                this.removeSubview(i),
                this.removeListItemFromDOM(i, n.index),
                this.appendReadMoreView())
            },
            onCollectionChange: function(e, t) {
                var n = u.call(this);
                o.prototype.onCollectionChange.apply(this, arguments),
                this._isShowingEmpty !== n && this.rerender(),
                this._isShowingEmpty = n
            },
            ...
            createSubviewWrapper: function(e) {
                ...
                return n = n.toString().length ? " " + n : "",
                t("<" + this.itemTagName + ' class="' + this.itemClassName + '"' + n + ">")
            },
            getSubviewWrapper: function(e) {
                return e.$el.parent()
            },
            addListItemToDOM: function(e, t) {
                var n, i, o = this.getListElement(), s = this.getSubviewWrapper(e), r = this.options.inverted;
                s.length || (s = this.createSubviewWrapper(e)).append(e.el),
                -1 === t || t >= this.getLength() - 1 || void 0 === t ? o[r ? "prepend" : "append"](s) : 0 === t ? o[r ? "append" : "prepend"](s) : (i = this.getListItemView(this.collection.at(t - 1))) && (n = this.getSubviewWrapper(i),
                s[r ? "insertBefore" : "insertAfter"](n)),
                this.resetElementCache()
            },
            ...
            removeListItemFromDOM: function(e, t) {
                var n, i = this.getSubviewWrapper(e), o = this.options.maxDisplay, s = !t || !1 !== t.animations;
                n = function() {
                    var t, n;
                    i.detach(),
                    e._dispose(),
                    !this._disposed && o && o <= this.collection.length && this.getLength() < o && (n = r.call(this),
                    (t = this.addListItemSubview(n)).render(),
                    this.addListItemToDOM(t, -1))
                }
                .bind(this),
                s && this.animations.remove ? this.addDeferred(window.setTimeout(i.fadeOut.bind(i, "slow", n), this.animations.remove.delay)) : n(),
                this.resetElementCache()
            },
        ...
        function l() {
            ...
            if (n)
                for (e = this.getLength(); e-- > n; )
                    (t = this.getListItemView(this.collection.at(n))) && (this.removeListItemFromDOM(t, {
                        animations: !1,
                        index: n
                    }),
...
, function(e, t, n) {
    ...
    e.exports = c.extend(l, {
        ...
        events: {
            ...
            "click a.title__h2": function() {
                r.trigger(u.UI.TITLE_LINK_CLICKED, this.model),
                this.isSound && r.trigger("sound:deeplink", this.$$("h2")[0], this.model)
            }
        },
        requiredAttributes: {
    ...
    function g() {
        var e, t, n, i, o = this.options.resource_type, r = this.model;
        switch (o) {
        case s.SOUND:
        case s.PLAYLIST:
            e = r.get("user").username,
            n = r.get("user").permalink_url,
            t = r.get("title"),
            i = this.getShareURL();
            break;
        case s.USER_SOUNDS:
        ...
        case s.USER_SPOTLIGHT:
            switch (e = r.get("username"),
            n = r.get("permalink_url"),
            o) {
            case s.USER_FAVORITES:
                t = a.t("Liked tracks");
                break;
...
, function(e, t, n) {
    ...
    function r(e) {
        ...
        "mouseenter" !== e.type || n && (!i || document.getElementById(i)) ? "mouseleave" === e.type && (this.toggleState("mouseover", !1),
        t.close()) : (this.toggleState("mouseover", !0),
        t.open())
    }
    function a() {
        var e = this.subviews.tooltip;
        return e && e.disposed && (this.removeSubview(e),
        e = null),
        e || (e = l.call(this),
        this.addSubview(e, "tooltip")),
        this.subviews.tooltip
    }
    function l() {
        return new o({
            togglerEl: this.el,
    ...
    e.exports = new o(r ? {
        ...
        after: {
            render: function() {
                var e, t, n;
                a && (a = !1,
                (e = this.performanceSelector) && (t = function() {
    ...
    e.exports = a.extend({
        ...
        events: {
            "click .artwork__link": function() {
                var e = this.model;
                s.trigger(r.UI.ARTWORK_CLICKED, e),
                s.trigger("sound:deeplink", this.$$("link")[0], e)
            }
        },
        defaults: {
        ...
        getTemplateData: function(e) {
            return i.extend(e, {
                ...
                wrapperStyle: (t = this.options.offset,
        ...
        e.exports = r.extend({
            ...
            url: function(e, t) {
                var n = "CREATE" === t || "DELETE" === t
                  ...
                  , s = l.parse(o);
                if (s.path = s.path.replace(/\/?$/, "/"),
                n)
                    s.path += e;
                else {
                    if (null !== this.next_href)
                        return this.next_href;
                    s.path += this.readPathSuffix,
                    s.query.linked_partitioning = 1,
                    s.query.limit = 200
                }
            ...
            fetch: function() {
                return this._fetchDefer || (this._fetchDefer = t.Deferred(),
                o.isLoggedIn() ? u.call(this) : s.one("connect:hasUserData", u.bind(this))),
                this._fetchDefer
            },
            parse: function(e) {
                return this.next_href = e.next_href || !1,
                i.reduce(e.collection, (function(e, t) {
                    return e[t] = !0,
                    e
                }
                ), {})
...
, function(e, t, n) {
    ...
    e.exports = o.extend({
        ...
        setup: function() {
            ...
            this.options.secret_token = e.get("secret_token"),
            this.soundDuration = e.duration(),
            e.release()
        },
...
, function(e, t, n) {
    ...
    e.exports = new i({
        ...
        getFillStyle: function(e, t) {
            return null == e && (e = 1),
            t = t || this.gradientName,
            this._fills = this._fills || {},
            this._fills[e + "_" + t] || (this._fills[e + "_" + t] = o.gradient(this.context, t, this.options.waveformStyle, this.options.scale, e))
        }
    })
}
, function(e, t, n) {
            ...
            normalizeEvent: function(e) {
                if (void 0 === e.offsetX || void 0 === e.offsetY) {
                    var n = t(e.target).offset()
                      , i = function(e) {
                        var t, n, i = e.type;
                        0 === i.indexOf("touch") ? (t = e.changedTouches[0].pageX,
                        n = e.changedTouches[0].pageY) : 0 === i.indexOf("mouse") ? (t = e.clientX + window.pageXOffset,
                        n = e.clientY + window.pageYOffset) : (t = e.x,
                        n = e.y);
                        return {
                            x: t,
                            y: n
...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports = u.extend(l, r, {
            ...
            setup: function() {
                this.toggleState("visual", this.options.visual),
                d.call(this, !0)
            },
            dispose: function() {
                d.call(this, !1)
        ...
        function h() {
            ...
            e && !t && (this.model.isPlaying() ? (this.$$("buttons").prepend(e.$el),
            this.toggleState("likeVisible")) : e.$el.detach())
        }
    }
    ).call(this, n(3))
}
    ...
    (function(t) {
        ...
        e.exports = new s({
            ...
            toggleTeaserView: function(e) {
                e ? this.teaserCanBeDisplayed() && (p.call(this),
                u = !0) : m.call(this)
            },
        ...
        function c() {
            ...
            })).on(a.Events.DISMISS, d, this),
            e.on(a.Events.DOWNLOAD_CLICK, h, this),
            e.render(),
            this.addSubview(e, "teaser"),
            this.$$("teaser").append(e.el))
        }
        function d() {
            this.toggleTeaserView(!1),
            this.onTeaserDismiss()
        }
        function h() {
        ...
        function p() {
            ...
            this._hideTeaserTimeoutId && clearTimeout(this._hideTeaserTimeoutId),
            c.call(this),
            e && (e.toggleBackgroundState(!0),
            e.toggleState("onlyArtwork", !0)),
            this.$el.toggleClass("teaserVisible", !0)
        }
        function m() {
            var e = this.subviews.visualAudible
              , t = this.subviews.teaser;
            t && (e && (e.toggleBackgroundState(!1),
            t.scaleUpArtwork(Math.max(this.$el.height() - e.$el.height(), 0))),
            this._hideTeaserTimeoutId = this.addDeferred(setTimeout(function() {
                e && e.toggleState("onlyArtwork", !1),
                t._dispose(),
                this.removeSubview(t),
                this.$el.toggleClass("teaserVisible", !1)
            }
    ...
    (function(t) {
        ...
        e.exports = new u({
            ...
            after: {
                setup: function() {
                    var e = v.call(this);
                    c.setSource(e),
                    p.call(this).done(m.bind(this)).fail(f.bind(this))
                }
            }
        });
        function p() {
            return (this.collection || this.model).isPopulated() && (!this.collection || this.collection.length || this.collection.isFullyPopulated()) ? h.resolve() : this.collection ? function e(t, n) {
                return t.fetch({
                    ...
                    if (0 === t.length && !t.isFullyPopulated())
                        return e(t, !0)
                }
                ))
        ...
        function m() {
            ...
            e instanceof i && !e.isEmbeddable() ? function(e) {
                ...
                g(t)
            }(e) : (c.setSource(e).setCursor(t.start_track),
            !t.auto_play || o.isMobileSafari || o.isAndroid || c.play(c.getCurrentSound()),
            r.trigger("widget:ready"))
        }
        function f(e) {
...
, , , , , function(e, t, n) {
    ...
    e.exports = c.extend(o, {
        ...
        setup: function() {
            this.observedAttributes = [this.options.resource_id],
            this.myFollowers = new a,
            this.setupModelListeners(this.myFollowers)
        },
        dispose: function() {
            this.teardownModelListeners(this.myFollowers),
            this.myFollowers.release(),
            delete this.myFollowers
        },
        renderDecorate: function() {
            var e = d.call(this);
            this.myFollowers.lastFetchTime || this.myFollowers.fetch(),
            this.toggleState("selected", e),
            this.$el.toggleClass("sc-button-cta", !e)
        },
        onClick: function(e) {
            var t = new r({
                id: this.options.resource_id
            });
            s.trigger(u.UI.FOLLOW_BUTTON_CLICKED, t),
            i.follow(this.options.resource_id, !d.call(this)),
            e.preventDefault()
        },
        getTemplateData: function() {
            var e = d.call(this)
...
, function(e, t, n) {
    (function(t) {
          ...
          , c = e.exports = i.extend({}, o.Events, {
            follow: function(e, t, n) {
                ...
                (r = n.origin) !== n.target && (n.target === a ? (o = u.followers).fetch().done((function() {
                    o.get(r) !== n.state && (o.toggle(r, n.state),
                    n.state = o.get(r),
                    d(n))
                }
                )) : (n.list = r === a ? u.followings : null,
                d(n)))
            },
        ...
        function d(e) {
            var n, o, r, a = !1, l = e.list, u = e.state, h = e.target, p = e.origin, m = e.requestType, f = p === s.currentUserId();
            return o = t.Deferred(),
            f && !s.isLoggedIn() ? s.login().done((function() {
                e.origin = s.currentUserId(),
                d(e).done(o.resolve).fail(o.reject)
            }
            )).fail(o.reject) : (l && f ? (n = function() {
                l.get(h) !== u ? (l.toggle(h, u),
                u = l.get(h),
                e.persist && (r = l.setRemote(h, u, m)) && r.fail((function(t, n) {
            ...
            ,
            l.fetch().done(n).done(o.resolve).fail(o.reject)) : o.resolve(),
            o.done((function() {
                if (!a) {
                    var t = e.action;
...
, function(e, t, n) {
    var i = n(596).sign
      , o = n(597).__FOLLOWS_SIGNATURE_SECRET__
      , s = n(542)
      , r = n(41)
      , a = n(5);
    e.exports = s.extend({
        ...
        e.exports = new o({
            ...
            after: {
                setup: function() {
                    ...
                    this.stateMachine = new r(this.options.sound_id,this.options.resource_id,e),
                    this.onState(a.INITIAL, this.onInitialState).onState(a.CURRENT_COMMENT, this.onCurrentCommentChange).onState(a.ACTIVE_TIMESTAMP, this.onActiveTimestamp).onState(a.CURRENT_TIMESTAMP, this.onCurrentTimestamp)
                },
                dispose: function() {
                    ...
                    this.sound.release(),
                    this.sound = null,
                    i.each(this._stateHandlers, (function(n, i) {
            ...
            cachedDimensions: function() {
                return this._cachedDimensions || (this._cachedDimensions = this.$el.offset(),
                this._cachedDimensions.width = this.$el.width(),
                this._cachedDimensions.height = this.$el.height()),
            ...
            onState: function(e, t) {
                return this._stateHandlers[e] = this._stateHandlers[e] || [],
                this.stateMachine.on(e, t, this),
                this._stateHandlers[e].push(t),
                this
            },
...
, function(e, t, n) {
    ...
    a.redirectLink = o.redirectLink,
    a.withDefaults = function(e) {
...
, function(e, t, n) {
    ...
    e.exports = new o({
        ...
        getWaveformHeightAt: function(e) {
            var t, n = this.options, i = this.canvas.width / n.scale, o = s.getConfig("gapWidth") + s.getConfig("barWidth"), r = Math.floor(e / o), a = e / i;
            return this._memo || (this._memo = new Array(Math.ceil(i / o))),
            null == this._memo[r] && (t = Math.floor(a * n.waveformWidth),
            this._memo[r] = n.waveformData[0][t]),
            this._memo[r]
        }
    })
}
, function(e, t, n) {
    (function(t) {
        ...
        e.exports = new o({
            ...
            override: {
                render: function() {
                    this.hasData() ? this.setDirty(!0) : (this.setDirty(!1),
                    this.fetchData())
                },
...
, function(e, t, n) {
    ...
    e.exports = o.extend({
        ...
        parse: function(e) {
            return this.audioSourceVersion = e.version || "no_version",
    ...
    (function(t) {
        ...
        e.exports = o.extend({
            ...
            setup: function(e) {
                ...
                this.collection.setLimit(20),
                a.on("resize:debounced", l, this)
            },
            dispose: function() {
                a.off("resize:debounced", l, this)
            },
            renderDecorate: function() {
                o.prototype.renderDecorate.apply(this, arguments),
                this.whenInserted().done(l.bind(this))
            },
            getListItemAttributes: function() {
                return {
                    style: c.call(this)
        ...
        function l() {
            ...
            this.toggleState("relatedVisible", e > 200),
            u.call(this)
        }
        function u() {
            var e = c.call(this);
...
, function(e, t, n) {
    (function(t) {
        ...
        function u(e) {
            ...
            return e = e ? i.clone(e) : {},
            s.getUserBySoundId(u).done((function(s) {
                s.getPlan() === o.Plans.PRO_UNLIMITED ? r.isFullyPopulated() ? n.resolve() : function(e, n) {
                    ...
                    t.length >= 2 ? (r.hasOwnSounds = !0,
                    r.next_href = !1,
                    r.lastFetchTime = Date.now(),
                    r[e.add ? "add" : "reset"](t, e),
                    n.resolve()) : d()
                }
                )).fail(n.reject) : d()
            }
...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports = new a({
            ...
            before: {
                setup: function() {
                    i.bindAll(this, "onDocumentClick", "onDocumentKeydown", "onWindowResize"),
                    c.call(this, !0),
                    this.$el.css({
                        outline: "none"
                    }),
            ...
            defaults: {
                ...
                isOpened: !1,
                open: function() {
                    this.disposed || this.isOpened || !this.canBeOpened() || (this.isOpened = !0,
                    this.rerender(),
                    this.$el.appendTo(document.body),
                    this.createContentView(),
                    this.position(),
                    this.options.focusable && this.$el.focus(),
                    this.trigger(l.OPENED),
                    s.trigger(l.OPENED, this))
                },
                close: function(e) {
                    !this.disposed && this.isOpened && (e || this.canBeClosed()) && (this.isOpened = !1,
                    this.$el.detach(),
                    this.closeDecorate(),
                    this.trigger(l.CLOSED))
                },
                ...
                createContentView: function() {
                    if (!this.getContentView() && this.options.Subview) {
                        var e, t = this.options, n = t.Subview, o = i.result(t, "subviewArgs");
                ...
                onDocumentKeydown: function(e) {
                    if (this.isOpened)
                        if (e.which === o.ESC) {
                            ...
                            if (!e.shiftKey && e.target === this.getElement("last-tabbable")[0])
                                return this.getElement("first-tabbable").focus(),
                                !1;
                            if (e.shiftKey && e.target === this.getElement("first-tabbable")[0])
                                return this.getElement("last-tabbable").focus(),
                                !1
                        }
                },
        ...
        function c(e) {
            var n = e ? "on" : "off";
            s[n](l.OPENED, this.onOverlayOpen, this),
            t(document)[n]("keydown", this.onDocumentKeydown),
            document[e ? "addEventListener" : "removeEventListener"]("click", this.onDocumentClick, !0),
            t(window)[n]("resize", this.onWindowResize)
        }
        function d(e, n) {
            ...
            l = r.clamp(l, g, v),
            u = r.clamp(u, m, f),
            this.options.relativeElement && a.length && "center top" === this.options.anchor && (a.css({
...
, function(e, t, n) {
    ...
    i = {
        getPurchaseTitle: function(e, t) {
            var n, i = e.purchase_url, o = this._shops;
            if (i && !e.purchase_title)
                if (o.Flattr.test(i))
                    e.purchase_title = "Flattr";
                else if (o["Getty Images"].test(i))
                    e.purchase_title = "License";
                else
                    for (n in e.purchase_title = t || "Buy",
                    o)
        ...
        getStoreName: function(e) {
            var t, n = e.purchase_url, i = this._shops;
            if (n)
                for (var o in i)
                    if (i[o].test(n)) {
                        t = o;
    ...
    e.exports ? e.exports = i : (window.SC = window.SC || {},
    window.SC.OnlineStores = i)
}
, function(e, t, n) {
    var i = n(519)
      , o = n(11)
    ...
    e.exports = r.extend(i, {
        ...
        events: {
            "click  .sharePanel__embedButton": function() {
                this.toggleState("embed", !0).$$("embedCodeInput").click(),
                o.trigger(s.UI.EMBED_BUTTON_CLICKED, this.model)
            },
            "click  .sharePanel__embedCodeInput": function(e) {
                l(e.target)
            },
            "click  .sharePanel__linkButton": function() {
                this.toggleState("embed", !1).$$("linkCodeInput").click(),
                o.trigger(s.UI.LINK_BUTTON_CLICKED, this.model)
            },
        ...
        setup: function() {
            this.options.show_embed_options = !!this.isAudible && this.options.show_embed_options,
            o.trigger(s.UI.SHARE_VIEW_OPENED, this.model)
        },
        getTemplateData: function(e) {
...
, function(e, t, n) {
    ...
    e.exports = u.extend(a, {
        ...
        setup: function() {
            ...
            this.observedAttributes[l.SOUND] = ["playable"],
            this.$el.toggleClass(this.options.size).attr("role", "application")
        },
        dispose: function() {
            c.call(this, !1)
        },
...
, function(e, t, n) {
    ...
    function r(e) {
        ...
        return e.diff(t.hex()).brightness < 20 && t.darken(5),
        t
    }
}
, function(e, t, n) {
    ...
    (function(t) {
        ...
        function i(e, n) {
            ...
            o(200).progress(i.notify).done((function() {
                e.removeClass("g-opacity-transition"),
                i.resolve()
            }
            )),
            i
        ...
        function o(e) {
            var n, i, o, s = t.Deferred(), r = Date.now();
    ...
    e.exports = s.extend(o, {
        ...
        states: {
            "state-small": function(e) {
                this.options.show_artwork = !e,
                this.toggleState("noArtwork", e),
                this.rerender()
            }
        }
    })
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        1: function(e, t, i, o, s) {
            ...
            ;
            return '  <div class="artworkWaveform__artwork">\n    ' + e.escapeExpression((n(517) || t && r(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, n(541), {
                name: "$view",
                hash: {
                    size: 80,
        ...
        main: function(e, t, i, o, s) {
            var r, a = null != t ? t : e.nullContext || {}, l = e.lookupProperty || function(e, t) {
                if (Object.prototype.hasOwnProperty.call(e, t))
                    return e[t]
            }
            ;
            ...
            })) ? r : "") + '<div class="artworkWaveform__waveform">\n  ' + e.escapeExpression((n(517) || t && l(t, "$view") || e.hooks.helperMissing).call(a, n(527), {
                name: "$view",
                hash: {
                    key: "waveform",
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        1: function(e, t, i, o, s) {
            var r, a = null != t ? t : e.nullContext || {}, l = e.hooks.helperMissing, u = e.escapeExpression, c = e.lookupProperty || function(e, t) {
                if (Object.prototype.hasOwnProperty.call(e, t))
                    return e[t]
            }
            ;
            ...
            }) : r) + '" title="' + u((n(518) || t && c(t, "$t") || l).call(a, "Open on SoundCloud", {
                name: "$t",
                hash: {},
                data: s,
                loc: {
        ...
        5: function(e, t, i, o, s) {
            ...
            ;
            return '    <div class="artwork__follow g-opacity-transition">\n      ' + e.escapeExpression((n(517) || t && a(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, n(561), {
                name: "$view",
                hash: {
        ...
        compiler: [8, ">= 4.3.0"],
        main: function(e, t, i, o, s) {
            var r, a, l = null != t ? t : e.nullContext || {}, u = e.hooks.helperMissing, c = e.escapeExpression, d = e.lookupProperty || function(e, t) {
                if (Object.prototype.hasOwnProperty.call(e, t))
                    return e[t]
            }
            ;
            ...
            })) ? r : "") + "    " + c((n(517) || t && d(t, "$view") || u).call(l, n(521), {
                name: "$view",
                hash: {
                    stretch: !0,
...
, function(e, t) {
    var n, i, o = ["userAgent", "charCodeAt", "sign", "navigator", "split", "toString", "unescape", "length", "encodeURIComponent", "__FOLLOWS_SIGNATURE_VERSION__"];
    n = o,
    i = 225,
    function(e) {
        for (; --e; )
    ...
    t[s("0x7")] = t[s("0x4")] = void 0,
    t.__FOLLOWS_SIGNATURE_VERSION__ = "1",
    t[s("0x7")] = function(e, n, i, o) {
        for (var r = window[s("0x8")][s("0x5")][s("0x9")](/[ /]/), a = t[s("0x4")] + o + i + o + n + e + r[r[0][s("0x2")] % r[s("0x2")]], l = window[s("0x1")](window[s("0x3")](a)), u = 7996111, c = 0; c < l[s("0x2")]; c += 1)
            u = (u >> 1) + ((1 & u) << 23),
            u += l[s("0x6")](c),
            u &= 16777215;
        return t.__FOLLOWS_SIGNATURE_VERSION__ + ":" + u[s("0x0")](16)
    }
}
, function(e, t, n) {
    "use strict";
    ...
    t.__FOLLOWS_SIGNATURE_SECRET__ = void 0,
    t.__FOLLOWS_SIGNATURE_SECRET__ = "5Dpr3ubBw8LFtbvQcd4Hx6hU"
}
, function(e, t, n) {
    var i = n(79);
    e.exports = (i.default || i).template({
        1: function(e, t, i, o, s) {
            ...
            ;
            return "  " + e.escapeExpression((n(518) || t && r(t, "$t") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, "Follow back", {
                name: "$t",
                hash: {
                    _context: "button",
        ...
        4: function(e, t, i, o, s) {
            ...
            ;
            return "    " + e.escapeExpression((n(518) || t && r(t, "$t") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, "Following", {
                name: "$t",
                hash: {
                    _context: "button",
        ...
        6: function(e, t, i, o, s) {
            ...
            ;
            return "    " + e.escapeExpression((n(518) || t && r(t, "$t") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, "Follow", {
                name: "$t",
                hash: {
                    _context: "button",
      ...
      , s = e.exports = {
        getMarkup: function(e, t, n) {
            ...
            return i.each(t, (function(e, t) {
                "style" === t && "object" == typeof e && (e = this.getStyleAttr(e)),
                a && -1 === a.indexOf(t) || r.push(" " + t + '="' + o.Utils.escapeExpression(e) + '"')
            }
            ), this),
            "<" + e + r.join("") + l + ">" + u
        },
...
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/cloudx200-41cfbaf1.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/cloudx500-d4b192f1.png"
}
, function(e, t) {
...
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/userx200-308b1978.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/userx500-404ae612.png"
}
, function(e, t, n) {
    var i = n(79);
    e.exports = (i.default || i).template({
        1: function(e, t, i, o, s) {
            ...
            ;
            return "  " + e.escapeExpression((n(543) || t && a(t, "$image") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, t, {
                name: "$image",
                hash: {
        ...
        main: function(e, t, i, o, s) {
            ...
            })) ? r : "") + e.escapeExpression((n(543) || t && l(t, "$image") || e.hooks.helperMissing).call(a, t, {
                name: "$image",
                hash: {
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, ".image{position:relative;width:100%;height:100%}.image__placeholder{position:absolute}.image__full{position:relative;opacity:1}.image__full,.image__placeholder{background-size:cover;background-position:50% 50%}.image.fadeIn>.image__full{opacity:0}", ""]),
    e.exports = t
}
, function(e, t, n) {
    var i = n(4)
...
, function(e, t, n) {
    ...
    e.exports = Class.extend([i.Events, {
        ...
        teardown: function() {
            var e;
            for (window.cancelAnimationFrame(this._raf),
            this._raf = null; e = this._layers.pop(); )
                e.off("dirty", o, this)
        },
        getLayers: function() {
            return this._layers
        ...
        addLayer: function(e) {
            this._layers.push(e),
            e.on("dirty", o, this),
            e.isDirty && s.call(this)
        },
        update: function() {
            var e, t;
            for (this._raf = null,
            e = 0; t = this._layers[e]; ++e)
                t.isDirty && t.update()
        }
    }]);
    function o() {
...
, function(e, t, n) {
    ...
    e.exports = o.extend({
        ...
        addNode: function(e) {
            ...
            this.addSubview(t).on("dirty", s, this).render()
        },
        ...
        update: function() {
            if (!this.disposed && this.isDirty) {
                var e, t, n = !1;
                for (this.context.clearRect(0, 0, this.el.width, this.el.height),
                e = 0; t = this.subviews[e]; ++e)
                    t.draw(),
                    n = n || t.isDirty;
                this.setDirty(n)
            }
    ...
    (function(t) {
        ...
        e.exports = o.extend({
            ...
            _setup: function() {
                this.context = this.el.getContext("2d"),
                this.scale = r,
                s.on("resize:x:debounced", a, this),
                o.prototype._setup.apply(this, arguments)
            },
            _dispose: function() {
                this.disposed || (s.off("resize:x:debounced", a, this),
                o.prototype._dispose.apply(this, arguments))
            },
            renderDecorate: function() {
            ...
            initCanvasDimensions: function(e, t) {
                var n = this.context
                  , o = n.canvas
                  , s = this.scale;
                o.width = (e || this.el.offsetWidth) * s,
                o.height = (t || this.el.offsetHeight) * s,
                i.isHiDPI && 1 !== s && n.scale(s, s)
            }
        });
        function a() {
            var e = this.$el.width()
              , t = this.$el.height();
            this.initCanvasDimensions(e, t),
            this.onCanvasResize()
        }
    }
    ).call(this, n(3))
...
, function(e, t, n) {
    (function(t) {
        var i, o, s = n(2), r = n(32), a = n(54), l = n(53), u = l.typedArrays ? Uint8Array : Array, c = (l.corsImg ? "//w1.sndcdn.com/" : "/_waveform/") + "90GaSwazbrh1_m.json", d = new a({
            maxLength: 500
        });
        e.exports = {
            loadWaveformDataForView: function(e) {
                var t = function(e) {
                    if (!e || e.indexOf("/images/player-waveform-medium.png") > -1)
                        return c;
        ...
        i = s.memoize((function() {
            var e, t = new u(1800);
            for (e = 0; e < 1800; ++e)
                t[e] = Math.round(15 * Math.sin(e / 1800 * Math.PI * 10) + 105);
            return t
        }
        )),
        o = s.memoize((function(e) {
            return function(t, n, i) {
                return t[i] = Math.round(Math.pow((e - n) / e, 1 / 1.5) * e),
                t
            }
        }
        ))
    ...
    (function(t) {
        ...
        e.exports = p.extend(d, {
            ...
            events: {
                click: function(e) {
                    ...
                    var t = Math.floor((w.call(this) || 0) / 1e3)
                      , n = this.sound;
                    n.isPrivate() || this.getState("snippet") || (window.open(n.get("permalink_url") + "#c=" + t + "&t=" + n.timecode()),
                    u.pause(n))
                },
                mouseleave: function() {
                ...
                "mousemove .commentPopover__scrub": function(e) {
                    ...
                    if (i === c.ACTIVE_TIMESTAMP)
                        return;
                    if (i === c.CURRENT_COMMENT && this.getCurrentComment() === n)
                        return;
                    this.setInteracting(!0),
                    n && this._hovered ? this.goToState(c.CURRENT_COMMENT, n.get("timestamp"), n) : this.goToState(c.CURRENT_TIMESTAMP, t)
                }
            },
            _hovered: !1,
            _hoverTimeout: null,
            setup: function(e) {
                ...
                i.bindAll(this, "onClickOutsideOfPointer"),
                f.call(this, !0),
                this.toggleState("darkText", e.darkText).toggleState("smallAvatar", 10 === e.avatarSize),
                this.$el.addClass(e.flagSize)
            },
            dispose: function() {
                f.call(this, !1),
            ...
            renderDecorate: function() {
                ...
                this.toggleState("visible", !!e).toggleState("commentLeft", !1).toggleState("snippet", this.sound.getMediaDuration() < t),
                e && this.setPosition(e.get("timestamp") / t)
            },
            setPosition: function(e) {
                ...
                e > .5 ? (o = t - o,
                s.width(o),
                i = this.getState("leaveCommentPlaceholder") ? -1 * this.$$("body").outerWidth() : -1 * (this.$$("username").outerWidth() + this.$$("body").outerWidth()),
                this.toggleState("commentLeft", !0)) : (s.width(o),
                this.toggleState("commentLeft", !1)),
                s.css({
            ...
            onActiveTimestamp: function(e, n) {
                _.call(this, n),
                t("html").on("mousedown", this.onClickOutsideOfPointer)
            },
            onClickOutsideOfPointer: function(e) {
                this.disposed || this.getCurrentState() !== c.ACTIVE_TIMESTAMP || t(e.target).closest(".commentPopover__wrapper").length || (this.goToState(c.INITIAL),
                t("html").off("mousedown", this.onClickOutsideOfPointer))
            }
        });
        function f(e) {
            var t = e ? "on" : "off";
            m[t]("resize:debounced", this.resetCachedDimensions, this),
            this.sound[t]("finish", g, this)
        }
        function g() {
        ...
        function v(e) {
            ...
            this.toggleState("leaveCommentPlaceholder", !0),
            this.$$("body").text(""),
            this.$$("body").attr("title", "").html(l.t("Leave a comment at [[timecode]]", {
                timecode: n
            })),
            this.$$("avatar").attr("title", "").css({
                "background-image": "url(" + i + ")"
            }),
            this.setPosition(e / this.sound.duration()),
            this.toggleState("visible", !0)
        }
        function _(e) {
            var t = this.getState("visible");
            e = e || this.getCurrentComment(),
            this.toggleState("leaveCommentPlaceholder", !1),
            e ? (b.call(this, e),
            this.setPosition(e.get("timestamp") / this.sound.duration()),
            this.toggleState("visible", !0)) : t && !e && this.toggleState("visible", !1)
        }
        function b(e) {
            var t = e.get("user")
              , n = t.username
              ...
              , s = a.urlFrom(t, 10);
            this.$$("username").attr("href", t.permalink_url).attr("title", o).text(n),
            this.$$("body").attr("title", o).html(i),
            this.$$("avatar").attr("title", o).css({
...
, function(e, t, n) {
    ...
    e.exports = i.extend({
        parse: function(e) {
            return null === e.timestamp && (e.timestamp = 1 / 0),
            e.user.avatar_url = e.user.avatar_url.replace("http:", "https:"),
            e
        }
    }, {
        EMPTY_TIMESTAMP: 1 / 0
...
, function(e, t, n) {
    var i, o = n(2), s = n(9), r = n(544), a = n(83), l = n(50), u = n(531);
    function c(e) {
        var t = e ? "on" : "off";
        this[t](u.INITIAL, this.onInitialState, this)[t](u.CURRENT_COMMENT, this.onCurrentComment, this)[t](u.CURRENT_TIMESTAMP, this.onCurrentTimestamp, this)[t](u.ACTIVE_TIMESTAMP, this.onActiveTimestamp, this),
        this.sound[t]("time", this.onAudioTime, this)
    }
    (i = function() {
        this.setup.apply(this, arguments)
    }
    ).extend = s.Model.extend,
    o.extend(i.prototype, s.Events, {
        constructor: i,
        currentComment: null,
        ...
        onAudioTime: o.throttle((function(e) {
            if (!this.disposed) {
                ...
                !this.interactingWithComments && this.sound.isPlaying() && ((t = this.collection.getCommentAtTimestamp(n, 300)) ? this.goToState(u.CURRENT_COMMENT, n, t) && (clearTimeout(this.commentIntervalTimeout),
                this.commentIntervalExceeded = !1,
                setTimeout(function() {
                    this.commentIntervalExceeded = !0
                }
                .bind(this), 1e3),
                clearTimeout(this.commentQuotaTimeout),
                this.commentQuotaExceeded = !1,
                this.commentQuotaTimeout = setTimeout(function() {
                    this.commentQuotaExceeded = !0,
                    this.onAudioTime(e)
                }
...
, function(e, t, n) {
    ...
    function T(e, t) {
        ...
        var Q = E ? l() : {}
          , J = Q.flatten
          , q = Q.addPlaceholder;
        return d.lastIndex = m.lastIndex = p.lastIndex = 0,
        e = o(e, {
            createElement: W
        }),
        ...
        e = e.replace(y, "\n\n").replace(w, "\n").replace(A, " "),
        e = F && F.length ? e.replace(new RegExp("<(?!\\s*\\/?(" + F.join("|") + ")\\b)[^>]*>","ig"), "") : e.replace(x, ""),
        K && (e = s(e)),
        E && (e = J(e = e, (function(e, t) {
            var o = {}
              , a = ""
              , l = _.test(e) ? e : "http://" + e
            ...
            if (u)
                o.href = e,
                o.text = e.replace("mailto:", "");
            else if (d)
                o.href = e.replace(g, N),
                o.text = e.replace(_, "");
            else if (M) {
                var h = v.test(l);
                o.href = h ? l : r(V, l, v),
            ...
            var p = s(o.href);
            return u || d || !M || v.test(l) || !V || "function" != typeof j || (p = j(p, l)),
            a + (o.text ? '<a href="' + p + '"' + (o.rel ? ' rel="' + o.rel + '"' : "") + (o.target ? ' target="' + o.target + '"' : "") + (o.title ? ' title="' + s(o.title) + '"' : "") + ">" + (K ? s(o.text) : o.text) + "</a>" : p)
        }
        )),
        I && (e = e.replace(m, '$1@<a href="' + N + '$2"' + (U ? ' target="_blank"' : "") + ">$2</a>")),
        R && (e = e.replace(f, '$1<a href="/tags/$3">$2</a>')),
        O && (e = e.replace(h, '<a href="#t=$1">$1</a>'))),
        H && (e = a(e, H, {
            createElement: W,
            Node: G
        })),
    ...
    function E(e, t) {
        var n = e;
        return t && t.redirectorPattern && (n = r(t.redirectorPattern, e, v)),
        t && t.redirectorPattern && "function" == typeof t.addChecksum && n !== e && (n = t.addChecksum(n, e)),
        n
    }
    T.redirectLink = E,
...
, function(e, t, n) {
    ...
    e.exports = function(e, t) {
        ...
        return n.innerHTML = e.replace(i, "&lt;"),
        n.value
    }
    ;
    var i = /</g
...
, function(e, t, n) {
    ...
    e.exports = function(e, t, n) {
        ...
        var r = o("div")
          , a = o("div");
        return a.innerHTML = r.innerHTML = e,
        i(r, (function(e) {
            if (t > 0) {
                var n = e.data.length;
...
, function(e, t, n) {
    ...
    e.exports = function(e, t, n) {
        ...
        i(l, (function(e) {
            r.lastIndex = 0,
            r.test(e.data) && (e.data = e.data.replace(r, (function(e) {
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        compiler: [8, ">= 4.3.0"],
        main: function(e, t, n, i, o) {
            var s, r = e.lambda, a = e.escapeExpression, l = e.lookupProperty || function(e, t) {
                if (Object.prototype.hasOwnProperty.call(e, t))
                    return e[t]
            }
            ;
...
, function(e, t, n) {
    ...
    e.exports = l.extend(c, a, r, {
        ...
        _isPlaying: !1,
        setup: function() {
            this._currentPlayingStep = this.model.isPlaying() ? 13 : 0,
            o.bindAll(this, "onHover"),
        ...
        onHover: function(e) {
            this._isHovered = "mouseenter" === e.type,
            this.setDirty(!0)
        },
        onResize: function() {
            this._pattern = null
        ...
        draw: function() {
            ...
            this._currentPlayingStep = o,
            this._currentHoverStep = s,
            this.isAnimating = h(s) || h(o);
            var r = Math.max(o, s)
              , a = this.getPlayableWidth()
              , l = this.getUnplayableWidth();
            e.save(),
            e.fillStyle = f.call(this),
            e.scale(1 / t, 1 / t),
            e.globalAlpha = i(r),
            e.fillRect(0, 0, a, n),
            l && (e.globalAlpha = .2,
    ...
    function d(e) {
        var t = e ? "on" : "off";
        this.model[t]("play", p, this),
        this.options.$eventEl[t]("mouseenter mouseleave", this.onHover)
    }
    function h(e) {
        return e > 0 && e < 13
    }
    ...
    function f() {
        ...
        var e, t, n, i, o, r = document.createElement("canvas"), a = this.options, l = this.canvas, c = r.getContext("2d"), d = a.scale, h = l.width / d, p = l.height / d, m = a.waveformHeight, f = u.getConfig("gapWidth"), g = u.getConfig("barWidth"), v = g + f, _ = a.upperPartHeight * p, b = p - _, y = this.getFillStyle(), w = f > 0, x = w && this.getFillStyle(1, "gapGradient"), k = null, A = null;
        for (r.width = l.width,
        r.height = l.height,
        s.isHiDPI && 1 !== d && c.scale(d, d),
        c.beginPath(),
        c.fillStyle = x,
        e = 0; e < h; e += v)
            i = this.getWaveformHeightAt(e),
            t = Math.floor(i / m * _),
            n = Math.floor((1 - i / m) * b + _),
            c.rect(e, t, g, n - t),
            w && e && (o = Math.max(t, k),
            c.fillRect(e - f, o, f, Math.min(n, A) - o)),
            k = t,
            A = n;
        return c.fillStyle = y,
        c.fill(),
        this._pattern = this.context.createPattern(r, "no-repeat"),
        this._pattern
    }
...
, function(e, t, n) {
    ...
    e.exports = {
        ...
        default: function() {
            ...
            return {
                progressGradient: [[0, t], [.7, n], [.701, t], [1, t]],
                backgroundGradient: [[0, s], [.7, s], [.701, s, .5], [1, s, .5]],
                gapGradient: [[0, "102,102,102", 0], [.28, "82,82,82", .6], [.7, s], [.701, s, .25], [1, s, .25]],
                scrubberGradientBackward: [[0, s, .5], [.7, s, .5], [.701, s, 0], [1, s, 0]],
                scrubberGradientForward: [[0, t, .5], [.7, n, .5], [.701, t, 0], [1, t, 0]],
                highlightGradientPlayed: [[0, t], [.7, n], [.701, t], [1, t]],
                highlightGradientUnplayed: [[0, "0,0,0", .5], [1, "0,0,0", .5]],
        ...
        inverted: function() {
            ...
            return {
                progressGradient: [[0, t], [.7, n], [.701, t], [1, t]],
                backgroundGradient: [[0, a], [.7, a], [.701, a, .4], [1, a, .4]],
                gapGradient: [[0, a, 0], [.28, a, .3], [.7, a, .5], [.701, a, .125], [1, a, .125]],
                scrubberGradientBackward: [[0, a, .5], [.7, a, .5], [.701, a, 0], [1, a, 0]],
                scrubberGradientForward: [[0, t, .5], [.7, n, .5], [.701, t, 0], [1, t, 0]],
                highlightGradientPlayed: [[0, t], [.7, n], [.701, t], [1, t]],
                highlightGradientUnplayed: [[0, a], [1, a]],
                progressIndicatorBg: l("0,0,0", .8),
                progressIndicatorColor: l("255,101,0", 1),
                durationIndicatorBg: l("0,0,0", .8),
                durationIndicatorColor: l(r, 1),
    ...
    (function(t) {
        ...
        e.exports = p.extend(c, a, h, {
            ...
            setup: function(e) {
                ...
                this._comments = [],
                i.bindAll(this, "onClick", "onMouseMove", "onMouseEnter", "onMouseLeave", "onClickOutsideOfPointer", "onPlaybackFinish"),
                v.call(this, "on")
            },
            dispose: function() {
            ...
            hasData: function() {
                if (m.hasData.call(this))
                    return _.call(this)
            },
            fetchData: function() {
                return m.hasData.call(this, this.collection) ? _.call(this) ? (this.toggleState("loadedAvatars", !0),
                r.resolve()) : b.call(this) : m.fetchData.call(this, this.collection)
            },
            onResize: function() {
            ...
            onMouseMove: function(e) {
                var t = this.getTimestampByMouseEvent(e)
                  , n = C.call(this, e)
                  , i = this.getCurrentState();
                e = u.normalizeEvent(e),
                P.call(this, e) ? i !== d.ACTIVE_TIMESTAMP && (i === d.CURRENT_COMMENT && this.getCurrentComment() === n || (n && this._hovered ? (this.setInteracting(!0),
                this.goToState(d.CURRENT_COMMENT, n.get("timestamp"), n)) : this.goToState(d.CURRENT_TIMESTAMP, t))) : i === d.CURRENT_COMMENT && this.goToState(d.INITIAL)
            },
        ...
        function v(e) {
            this.options.$eventEl[e]("click", this.onClick)[e]("mousemove", this.onMouseMove)[e]("mouseenter", this.onMouseEnter)[e]("mouseleave", this.onMouseLeave),
            this.sound[e]("finish", this.onPlaybackFinish)
        }
        function _() {
        ...
        function b() {
            ...
            return this._avatarsDeferred = this.addDeferred(r.settled(e).done(function() {
                this.setDirty(!0),
                this.toggleState("loadedAvatars", !0)
            }
            .bind(this))),
        ...
        function y(e) {
            ...
            i && null != n && !(n < 0))
                ...
                c = -1 !== (o = (u = !!(a = i.get("user")).avatar_t20x20) ? a.avatar_t20x20 : a.avatar_url).indexOf("default_avatar"),
                this.sound.get("comment_count") < 50 || !c ? (d = {
                    view: this,
                ...
                u ? w(d) : function(e) {
                    g.push(e),
                    x()
                }(d)) : (this._comments.unshift(s),
                t.resolve()),
                t
        }
        function w(e) {
            var t = new Image;
            t.onload = A.bind(e.view, t, e.info, e.imgDefer),
            t.onerror = S.bind(e.view, e.info, e.imgDefer),
            t.src = e.url
        }
        function x() {
            for (var e, t, n = f.length; n < 10 && (t = g.shift()); )
                "pending" === (e = t.imgDefer).state() && (n = f.push(t),
                w(t),
                e.always(k(t)))
        }
        function k(e) {
        ...
        function A(e, t, n) {
            this.disposed || (t.el = e,
            this._comments.unshift(t)),
            n.resolve()
        }
        function S(e, t) {
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, ".waveformCommentsNode{opacity:0;transition:opacity .2s ease-in-out}.waveformCommentsNode.loaded{opacity:1}", ""]),
    e.exports = t
}
, function(e, t, n) {
    (function(t) {
        var i, o = n(2), s = n(5), r = n(546), a = n(19), l = n(53), u = n(38), c = n(528), d = Math.floor, h = t(window), p = function() {
            return !1
        }, m = l.touch ? "touchstart" : "mousedown", f = l.touch ? "touchmove" : "mousemove", g = l.touch ? "touchend" : "mouseup";
        e.exports = u.extend(c, {
            states: {
                scrubbing: function(e) {
                    document.onselectstart = e ? p : null,
                    i.toggleClass("sc-selection-disabled", e)
                }
            },
            _cachedOffset: null,
            draw: t.noop,
            setup: function() {
                i = i || s.get("appView").$el,
                o.bindAll(this, "onPointerDown", "onPointerMove", "onPointerUp"),
                _.call(this, "on")
            },
            dispose: function() {
                _.call(this, "off")
            ...
            onPointerDown: function(e) {
                ...
                this.toggleState("scrubbing", !0),
                h.on(g, this.onPointerUp),
                t.isPlaying() ? v.call(this, e) : this.insideTopArea(e.offsetY * n) && a.toggle(this.model, {
                    userAction: !0
                })
            },
            onPointerUp: function(e) {
                h.off(g, this.onPointerUp),
                this.toggleState("scrubbing", !1)
            },
            onPointerMove: function(e) {
                l.touch && e.preventDefault(),
                e = r.normalizeEvent(e),
                this.getState("scrubbing") && this.model.isPlaying() && v.call(this, e)
            },
...
, function(e, t, n) {
    ...
    e.exports = s.extend(r, i, o, {
        ...
        draw: function() {
            ...
            e.fillRect(0, 0, r, this.canvas.height),
            l && (e.fillStyle = this.getFillStyle(l / s),
            e.fillRect(r, 0, s, this.canvas.height)),
            e.restore()
        }
    });
    function l(e) {
...
, function(e, t, n) {
    var i, o = n(2), s = n(545), r = n(546), a = n(38), l = n(528);
    e.exports = a.extend(l, s, {
        ...
        _isHovering: !1,
        setup: function() {
            o.bindAll(this, "onMouseLeave", "onMouseMove"),
            c.call(this, "on")
        },
        dispose: function() {
            c.call(this, "off"),
        ...
        onMouseMove: function(e) {
            ...
            (this._isHovering = this.insideScrubbableArea(e.offsetX * i, e.offsetY * i)) && (this._mouseX = e.offsetX),
            t === this._mouseX && n === this._isHovering || this.setDirty(!0)
        },
        draw: function() {
            this._targetStep = this.model.isPlaying() && this._isHovering ? 13 : 0;
            var e = d.call(this)
              , t = i(e);
            this.isAnimating = e !== this._currentStep,
            this._currentStep = e,
            u.call(this, t)
        }
    });
    function u(e) {
        if (e) {
            ...
            t.fillStyle = this.getFillStyle(e, r < o ? "scrubberGradientForward" : this.gradientName),
            t.fillRect(Math.min(r, o), 0, Math.abs(r - o), n.height),
            t.restore()
        }
    }
    function c(e) {
...
, function(e, t, n) {
    ...
    e.exports = s.extend(r, o, {
        ...
        draw: function() {
            ...
            t.save(),
            t.translate(.5, .5),
            t.fillStyle = a.getColor("durationIndicatorBg", s),
            t.fillRect(h - d, m, d, 14),
            (r > 0 || o.isPlaying()) && (t.fillRect(0, m, c + 4, 14),
            t.fillStyle = a.getColor("progressIndicatorColor", s),
            t.fillText(l, 2, Math.floor(p - 4))),
            t.fillStyle = a.getColor("durationIndicatorColor", s),
            t.fillText(u, Math.floor(h - d + 2), Math.floor(p - 4)),
            this._lastSecs = Math.floor(r / 1e3),
            t.restore()
        }
    });
    function l(e) {
...
, function(e, t, n) {
    ...
    function s(e) {
        ...
        this.width = e.width || e.canvas.offsetWidth,
        this.height = e.height || e.canvas.offsetHeight,
        this.devicePixelRatio = window.devicePixelRatio ? window.devicePixelRatio : 1,
        this.backingStoreRatio = o.backingStoreRatio,
        this.canvasPixelRatio = this.devicePixelRatio / this.backingStoreRatio,
        this.canvas.setAttribute("width", this.width * this.canvasPixelRatio),
        this.canvas.setAttribute("height", this.height * this.canvasPixelRatio),
        this.devicePixelRatio !== this.backingStoreRatio && this.context.scale(this.canvasPixelRatio, this.canvasPixelRatio)
    }
    function r(e, t) {
        return {
            x: e.x * t,
    ...
    i.extend(s.prototype, {
        ...
        getImageData: function(e, t) {
            return e = r(e, this.canvasPixelRatio),
            t = r(t, this.canvasPixelRatio),
            this.context.getImageData(e.x, e.y, t.x - e.x, t.y - e.y)
        }
    })
}
, function(e, t, n) {
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        1: function(e, t, i, o, s) {
            ...
            ;
            return "      " + e.escapeExpression((n(517) || t && a(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, n(653), {
                name: "$view",
                hash: {
                    key: "visuals",
        ...
        3: function(e, t, i, o, s) {
            ...
            ;
            return "      " + u((n(517) || t && c(t, "$view") || l).call(a, n(521), {
                name: "$view",
                hash: {
                    size: 500,
                    stretch: !0,
        ...
        5: function(e, t, i, o, s) {
            ...
            ;
            return '      <div class="visualAudible__total g-transition-opacity">\n        ' + e.escapeExpression((n(517) || t && a(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, n(657), {
                name: "$view",
                hash: {
                    key: "soundsTotal",
                    resource_type: null != (r = null != t ? a(t, "_options") : t) ? a(r, "resource_type") : r,
        ...
        7: function(e, t, i, o, s) {
            ...
            ;
            return '      <div class="visualAudible__progressBar g-transition-opacity">\n        ' + e.escapeExpression((n(517) || t && r(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, n(573), {
                name: "$view",
                hash: {
                    resource_type: null != t ? r(t, "_resource_type") : t,
                    resource_id: null != t ? r(t, "_resource_id") : t
        ...
        9: function(e, t, i, o, s) {
            ...
            ;
            return '<div class="visualAudible__blocked g-transition-transform">\n  ' + e.escapeExpression((n(517) || t && r(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, n(668), {
                name: "$view",
                hash: {
        ...
        main: function(e, t, i, o, s) {
            ...
            })) ? r : "") + '  </div>\n  <div class="visualAudible__body">\n    <div class="visualAudible__header">\n      ' + e.escapeExpression((n(517) || t && l(t, "$view") || e.hooks.helperMissing).call(a, n(549), {
                name: "$view",
                hash: {
                    key: "header",
    ...
    function l() {
        if (!this.disposed) {
            var e = this.model.currentTime()
              ...
              , s = t[n];
            n !== this.currentVisualIndex && (this.currentVisualIndex = n,
            this.$$("backgroundLayer").css("background-image", "url(" + s.visual_url + ")"),
            this.$$("item").removeClass("visible").filter('[data-timestamp="' + s.entry_time + '"]').addClass("visible"))
        }
    }
}
, function(e, t, n) {
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        1: function(e, t, n, i, o) {
            var s, r = null != t ? t : e.nullContext || {}, a = e.hooks.helperMissing, l = e.escapeExpression, u = e.lookupProperty || function(e, t) {
                if (Object.prototype.hasOwnProperty.call(e, t))
                    return e[t]
            }
            ;
...
, function(e, t, n) {
    ...
    e.exports = r.extend(s, {
        ...
        setup: function(e) {
            ...
            this.trackCountProperty && (this.requiredAttributes = [this.trackCountProperty])
        },
        renderDecorate: function() {
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        ...
        main: function(e, t, i, o, s) {
            ...
            ;
            return '<div class="soundsTotal__number sc-font-tabular">' + l((n(661) || t && u(t, "$shortnumber") || a).call(r, null != t ? u(t, "track_count") : t, {
                name: "$shortnumber",
                hash: {},
                data: s,
                loc: {
            ...
            })) + '</div>\n<div class="soundsTotal__tracks">' + l((n(547) || t && u(t, "$tp") || a).call(r, null != t ? u(t, "track_count") : t, "track", "tracks", {
                name: "$tp",
                hash: {},
                data: s,
                loc: {
...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports = s.extend({
            ...
            _throttleTimeout: 0,
            setup: function() {
                this.loadedProgress = this._getLoadedProgress(),
                this.playedProgress = this._getPlayedProgress(),
                this.isFullyLoaded = !1,
                i.bindAll(this, "onAudioFinish", "updateProgressBar", "rethrottle", "onInitialPlay", "onAudioPlay", "onAudioPause", "timedUpdate"),
                r.on("resize:debounced", this.rethrottle, this),
                this.model.on("finish", this.onAudioFinish).on("time", this.onInitialPlay).on("seeked", this.updateProgressBar)
            },
            dispose: function() {
                this.model.off("finish", this.onAudioFinish).off("time", this.onInitialPlay).off("seeked", this.updateProgressBar),
                r.off("resize:debounced", this.rethrottle, this)
            },
            renderDecorate: function() {
                this.updateProgressBar(),
                this.model.on("play", this.onAudioPlay).on("pause", this.onAudioPause),
                this.model.isPlaying() && (this._throttleTime || this.rethrottle(),
                this._throttleTimeout || this.timedUpdate())
            },
            teardown: function() {
                this.stopTimedUpdates(),
                this.model.off("play", this.onAudioPlay).off("pause", this.onAudioPause)
            },
            onInitialPlay: function() {
                this.model.off("time", this.onInitialPlay),
                this.updateProgressBar()
            },
            ...
            onAudioPlay: function() {
                this._throttleTime || this.rethrottle(),
                this._throttleTimeout || this.timedUpdate()
            },
            rethrottle: function() {
                if (!this.disposed) {
                    var e, t, n = this.el.clientWidth;
                    n !== this._lastContainerSize && (this._lastContainerSize = n,
                    e = this.model.duration(),
                    0 === n ? (this._throttleTime = 0,
                    "pending" === (t = this.whenInserted()).state() && t.done(this.rethrottle)) : this._throttleTime = Math.max(40, Math.floor(e / n)))
                }
            },
            updateLoaded: t.noop,
            updatePlayed: t.noop,
            ...
            updateProgressBar: function() {
                this.disposed || (this.playedProgress = this._getPlayedProgress(),
                this.isFullyLoaded || (this.loadedProgress = this._getLoadedProgress(),
                this.isFullyLoaded = 1 === this.loadedProgress,
                this.updateLoaded()),
                this.updatePlayed())
            },
            ...
            timedUpdate: function() {
                ...
                this.updateProgressBar(),
                e = Math.max(40, t && t - this.model.currentTime() % t),
                this._throttleTimeout = setTimeout(this.timedUpdate, e)
            },
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, '.thinProgressbar{height:3px;width:100%;position:relative}.thinProgressbar:after{content:"";display:block;position:absolute;height:11px;width:100%;top:-4px;left:0}.thinProgressbar__layer{position:absolute;height:100%;width:100%}.thinProgressbar__played{width:0;background-color:$mainColor}', ""]),
    e.exports = t
}
, function(e, t, n) {
    (function(t) {
        ...
        e.exports = new l({
            applyTo: function(e) {
                ...
                e.events = e.events || {},
                e.events[p] = "onPointerDown",
                e.events[m] = "onPointerMove",
                e.states = i.extend({}, e.states, {
                    "selection-disabled": function(e) {
                        e ? (document.onselectstart = function() {
                            return !1
                        }
                        ,
                        u.addClass("sc-selection-disabled")) : (document.onselectstart = null,
                        u.removeClass("sc-selection-disabled"))
                    }
                })
            },
            before: {
                setup: function() {
                    ...
                    this.scrub = i.throttle(this.scrub.bind(this), 50),
                    this.unscrub = this.unscrub.bind(this),
                    this.onWindowResize = i.debounce(this.onWindowResize.bind(this), 100),
                    _.call(this, !0)
                },
                dispose: function() {
                    _.call(this, !1)
            ...
            defaults: {
                ...
                onPointerDown: function(e) {
                    ...
                    this.scrubbingEnabled && this.model.isPlaying() ? (f.call(this, e.originalEvent.pageX),
                    c.on(m, this.scrub).on(h, this.unscrub)) : s.toggle(this.model, {
                        userAction: !0
                    })
                },
                onPointerMove: function(e) {
                ...
                scrub: function(e) {
                    if (!v.call(this, e))
                        return c.trigger(h);
                    this.toggleState("selection-disabled", !0),
                    f.call(this, e.originalEvent.pageX)
                },
                unscrub: function() {
                    this.toggleState("selection-disabled", !1),
                    c.off(m, this.scrub).off(h, this.unscrub),
                    a.touch && this.trigger(d.MOUSE_LEAVE)
                }
            }
        });
        function f(e) {
            this.model.seek(g.call(this, e)),
            this.onSeek()
        }
        function g(e) {
            var t;
            return t = (e - y.call(this).left) / b.call(this),
            Math.floor(t * this.model.duration())
        }
        function v(e) {
        ...
        function _(e) {
            var n = e ? "on" : "off";
            t(window)[n]("resize", this.onWindowResize),
            this.model[n]("play", this.onPlay, this)[n]("pause", this.onPause, this)
        }
        function b() {
            return this.width = this.width || this.$el.width(),
            this.width
        }
        function y() {
            var e = this.$el.offset();
            return e.right = e.left + this.$el.width(),
            e.bottom = e.top + this.$el.height(),
            e
        }
        function w() {
...
, function(e, t, n) {
    ...
    e.exports = i.extend({
        ...
        renderDecorate: function() {
            this.relatedSounds.fetch().done(r.bind(this)),
            this.whenInserted(r.bind(this))
        },
        getTemplateData: function(e) {
            return e.getRelatedSounds = a,
            e
        }
    });
    function r() {
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        ...
        main: function(e, t, i, o, s) {
            ...
            })) + "\n  </div>\n  " + u((n(517) || t && c(t, "$view") || l).call(a, n(575), {
                name: "$view",
                hash: {
...
, function(e, t, n) {
    ...
    e.exports = o.extend({
        ...
        getTemplateData: function(e) {
            return e.shareUrl = this.model.getShareURL(),
            e
        }
    })
}
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        ...
        main: function(e, t, i, o, s) {
            ...
            })) + '\n  <div class="visualSoundBadge__title">\n    ' + u((n(517) || t && c(t, "$view") || l).call(a, n(535), {
                name: "$view",
                hash: {
                    show_link: !1,
                    visual: !0,
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        1: function(e, t, n, i, o) {
            var s, r, a = null != t ? t : e.nullContext || {}, l = e.hooks.helperMissing, u = e.escapeExpression, c = e.lookupProperty || function(e, t) {
                if (Object.prototype.hasOwnProperty.call(e, t))
                    return e[t]
            }
            ;
        ...
        12: function(e, t, n, i, o) {
            var s, r, a = null != t ? t : e.nullContext || {}, l = e.hooks.helperMissing, u = "function", c = e.escapeExpression, d = e.lookupProperty || function(e, t) {
                if (Object.prototype.hasOwnProperty.call(e, t))
                    return e[t]
            }
            ;
        ...
        19: function(e, t, i, o, s) {
            ...
            }) : r) + '</span>\n        <span class="sc-media-content title__explicit">' + u((n(517) || t && c(t, "$view") || l).call(a, n(548), {
                name: "$view",
                hash: {
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, ".explicitBadge{display:inline-block;padding:0 1px;font-size:10px;line-height:12px;height:12px;text-transform:uppercase}", ""]),
    e.exports = t
}
, function(e, t, n) {
    var i = n(4)
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, ".visualSoundBadge{position:relative;overflow:hidden}.visualSoundBadge__title{position:absolute;top:5px;left:5px;right:5px}", ""]),
    e.exports = t
}
, function(e, t, n) {
    var i = n(4)
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, ".relatedVisualSounds{position:relative;overflow:hidden;width:100%;height:100%;display:none}.relatedVisualSounds.relatedVisible{display:block}.relatedVisualSounds__item{float:left;margin-left:10px}.relatedVisualSounds__item:first-child{margin-left:0}", ""]),
    e.exports = t
}
, function(e, t, n) {
    var i = n(4)
...
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/geoblock-21961a09.png"
}
, function(e, t, n) {
    var i = n(4)
      , o = n(685);
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        1: function(e, t, i, o, s) {
            ...
            ;
            return '    <div class="soundHeader__snippetIndicator g-transition-opacity">\n      ' + e.escapeExpression((n(517) || t && r(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, n(550), {
                name: "$view",
                hash: {
                    backgroundColor: !0,
                    size: "medium",
        ...
        3: function(e, t, n, i, o) {
            var s, r = null != t ? t : e.nullContext || {}, a = e.lookupProperty || function(e, t) {
                if (Object.prototype.hasOwnProperty.call(e, t))
                    return e[t]
            }
            ;
        ...
        4: function(e, t, i, o, s) {
            ...
            ;
            return "          " + e.escapeExpression((n(517) || t && r(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, n(689), {
                name: "$view",
                hash: {
        ...
        6: function(e, t, i, o, s) {
            ...
            ;
            return "          " + e.escapeExpression((n(517) || t && r(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, n(695), {
                name: "$view",
                hash: {
                    visual: null != t ? r(t, "visual") : t,
                    size: "small",
        ...
        9: function(e, t, i, o, s) {
            ...
            ;
            return "            " + e.escapeExpression((n(517) || t && r(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, n(697), {
                name: "$view",
                hash: {
                    visual: null != t ? r(t, "visual") : t,
                    size: "small",
        ...
        11: function(e, t, i, o, s) {
            ...
            ;
            return "          " + e.escapeExpression((n(517) || t && r(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, n(698), {
                name: "$view",
                hash: {
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, ".snippetIndicator.snippetIndicatorBackgroundActive{background:rgba(0,0,0,.2)}", ""]),
    e.exports = t
}
, function(e, t, n) {
    var i = n(562)
    ...
    e.exports = c.extend(o, r, {
        ...
        renderDecorate: function() {
            ...
            this.toggleState("selected", e),
            this.$el.attr("title", t).html(t)
        },
        onClick: function(e) {
            var t = this.options;
            s.trigger(u.UI.LIKE_BUTTON_CLICKED, this.model),
            i.like(t.resource_id, t.resource_type, !this.model.get(t.resource_id)),
            e.preventDefault()
        }
    })
}
, function(e, t, n) {
    ...
    e.exports = o.extend(i, {
        ...
        setup: function() {
            var e = this.options;
            !e.text && e.relativeElement && (e.text = e.relativeElement.title,
            e.relativeElement.removeAttribute("title"))
        },
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, ".tooltip{padding:3px 7px;opacity:0;transition:opacity .1s linear;font-size:12px;line-height:15px}.tooltip.visible{opacity:1}", ""]),
    e.exports = t
}
, function(e, t, n) {
    var i = n(522)
    ...
    e.exports = c.extend(o, r, {
        ...
        renderDecorate: function() {
            var e = "sound" === this.options.resource_type
              , t = this.model
              , {purchase_url: n, purchase_title: i} = t.toJSON()
              , o = {
                purchase_url: n,
                purchase_title: d(i, {
                    hash: {
              ...
              , s = l.getPurchaseTitle(o, e ? a.t("Buy", null, {
...
, function(e, t, n) {
    ...
    e.exports = function(e, t) {
        return (void 0 === t.hash.escapeExpression || t.hash.escapeExpression) && (e = o.Utils.escapeExpression(e)),
        new o.SafeString(s(e, t.hash))
    }
}
, function(e, t, n) {
    (function(t) {
...
, function(e, t, n) {
    ...
    e.exports = d.extend(i, o, s, c, {
        ...
        onClick: function() {
            ...
            r.trigger(l.UI.SHARE_BUTTON_CLICKED, this.model),
            this.options.overlay ? this.toggleOverlay() : this.rerender()
        }
    });
    function h() {
...
, function(e, t, n) {
    ...
    e.exports = new s({
        ...
        defaults: {
            ...
            getOverlay: function() {
                ...
                return e && e.disposed && (this.removeSubview(e),
                e = null),
                e || ((e = r.call(this)).on([o.Events.CLOSED, o.Events.OPENED].join(" "), l, this),
                this.addSubview(e, "overlay")),
                this.subviews.overlay
            }
        },
        before: {
            setup: function() {
                i.bindAll(this, "toggleOverlay"),
                this.domId = i.uniqueId("overlay-"),
                this.$el.attr({
                    "aria-haspopup": "true",
    ...
    function r() {
        ...
        return e = a.call(this, n.ContentViewClass),
        t = i.extend({
            resource_id: n.resource_id,
            resource_type: n.resource_type
        }, n.contentViewOptions),
        new o({
            togglerEl: this.el,
            relativeElement: this.el,
            Subview: e,
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, ".dialog{padding:10px}", ""]),
    e.exports = t
}
, function(e, t, n) {
    var i = n(79);
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        1: function(e, t, i, o, s) {
            ...
            ;
            return '    <div class="sc-media-right">\n      <button class="sharePanel__embedButton sc-button">' + e.escapeExpression((n(518) || t && r(t, "$t") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, "Embed", {
                name: "$t",
                hash: {},
                data: s,
                loc: {
        ...
        3: function(e, t, i, o, s) {
            ...
            ;
            return '<div class="sharePanel__embedCode sc-media">\n  <div class="sc-media-right">\n    <button class="sharePanel__linkActionButton sharePanel__linkButton sc-button">' + e.escapeExpression((n(518) || t && l(t, "$t") || e.hooks.helperMissing).call(a, "Link", {
                name: "$t",
                hash: {},
                data: s,
                loc: {
...
, function(e, t) {
    e.exports = {
        extract: function(e) {
            var t, n, i, o = e.tag_list || "", s = e.genre || "", r = [], a = "", l = !1, u = !0, c = /(\w+)\:(\w+)=(.+)/;
            for (s && r.push(s),
            t = 0,
            n = o.length; t < n; ++t)
                '"' === (i = o.charAt(t)) ? l = !l : " " === i ? l ? a += i : !1 === u && (u = !0,
                r.push(a),
                a = "") : (u = !1,
                a += i);
            return u || r.push(a),
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, ".shareIcon{display:inline-block}", ""]),
    e.exports = t
}
, function(e, t, n) {
    var i = n(79);
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        1: function(e, t, i, o, s, r, a) {
            ...
            ;
            return '  <li class="shareIcons__icon">\n    ' + e.escapeExpression((n(517) || t && u(t, "$view") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, t, {
                name: "$view",
                hash: {
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, ".shareIcons__icon{float:left;margin:0 4px 0 0}", ""]),
    e.exports = t
}
, function(e, t, n) {
    var i = n(4)
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        compiler: [8, ">= 4.3.0"],
        main: function(e, t, n, i, o) {
            var s, r, a = null != t ? t : e.nullContext || {}, l = e.hooks.helperMissing, u = e.escapeExpression, c = e.lambda, d = e.lookupProperty || function(e, t) {
                if (Object.prototype.hasOwnProperty.call(e, t))
                    return e[t]
            }
            ;
...
, function(e, t, n) {
    (t = n(1)(!1)).push([e.i, ".logo,.logo:focus,.logo:hover{outline:0}", ""]),
    e.exports = t
}
, function(e, t, n) {
    var i = n(79);
...
, , , , , , , , , , function(e, t, n) {
    ...
    e.exports = h.extend(l, {
        ...
        getTemplateData: function(e) {
            ...
            return e.consubUpsell = v(t),
            e.consubButtonSize = k() ? "sc-button-large" : "sc-button sc-button-medium",
            e.consubButtonText = g() ? u.t("Hear full track") : u.t("Try it free for 30 days"),
            e.link = s.replace("__browser_locale__", u.getBrowserPrimaryLocale()),
            e.hasCountDown = this.options.hasCountDown,
            e.locale = u.getLocale(),
            e.isMobile = g(),
            e.downloadAppText = a.isiOS ? u.t("Download on the App Store") : u.t("Get in on Google Play"),
    ...
    function _() {
        if (this.options.hasCountDown && (this._leftSecondsToClose = 15,
        b.call(this)),
        v(this.model)) {
            var e = {
                impression: "consumer_sub_upgrade",
    ...
    function b() {
        this.disposed || (this._leftSecondsToClose -= 1,
        this.$$("countdown").text(this._leftSecondsToClose),
        this._leftSecondsToClose > 0 ? setTimeout(b.bind(this), 1e3) : y.call(this))
    }
    function y() {
    ...
    function x(e) {
        ...
        v += h / 2),
        v = Math.abs(v),
        this.toggleState("artworkHidden", !f),
        this.$$("text").css({
            top: g,
            left: o,
            right: o
...
, function(e, t, n) {
    ...
    e.exports = (i.default || i).template({
        1: function(e, t, i, o, s) {
            ...
            ;
            return '    <h2 class="sc-font-light sc-truncate">' + l((n(518) || t && u(t, "$t") || a).call(r, "Upgrade to SoundCloud Go+", {
                name: "$t",
                hash: {},
                data: s,
                loc: {
            ...
            })) + '</h2>\n    <h2 class="teaser__consubUpsellText sc-font-light sc-text-light">' + l((n(518) || t && u(t, "$t") || a).call(r, "Get our expanded catalog, with offline listening and no ads.", {
                name: "$t",
                hash: {},
                data: s,
                loc: {
        ...
        5: function(e, t, i, o, s) {
            ...
            }) : a) + '</a>\n    <div class="teaser__restrictions">\n      ' + (null != (r = (n(518) || t && d(t, "$t") || u).call(l, "[[[spanStart]]]Restrictions apply - [[[spanEnd]]] [[[linkStart]]]See details to learn more[[[linkEnd]]]", {
                name: "$t",
                hash: {
                    linkEnd: "</a>",
        ...
        15: function(e, t, i, o, s) {
            ...
            ;
            return '  <div class="teaser__timer sc-font-light sc-truncate">' + (null != (r = (n(518) || t && a(t, "$t") || e.hooks.helperMissing).call(null != t ? t : e.nullContext || {}, "Back to track in [[[seconds]]]", {
                name: "$t",
                hash: {
        ...
        main: function(e, t, i, o, s) {
            ...
            })) ? r : "") + '\n<button class="teaser__dismiss" type="button"\n        aria-label="' + (null != (r = (n(518) || t && d(t, "$t") || u).call(l, {
                name: "$t",
                hash: {
            ...
            }) : a) + '">' + c((n(517) || t && d(t, "$view") || u).call(l, n(521), {
                name: "$view",
                hash: {
                    size: 500,
                    stretch: !0,
...
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-02d8612c.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_193x57-a8a90d1e.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_192x57-47a7f9da.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-900bd743.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_192x57-042e925e.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-d83e43e3.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_193x57-f26c69b0.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-7990a48b.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_193x57-00d76eeb.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-b79c95cd.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_193x57-5adad32b.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-a8473a14.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_193x57-eab52871.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-b0cb6ba0.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_193x57-fdf3cd5d.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-a14dcd5e.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_193x57-86150382.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-a976c768.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_193x57-2c2d6d83.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-0ef4d283.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_192x57-7741a9b9.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-53d3965c.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_192x57-e9fc717b.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-b3d655ee.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_192x57-133a4e93.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_165x57-455c9676.png"
}
, function(e, t) {
...
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/sc_white_96x48-d7222a81.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-a84e9569.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-78147fe1.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-86c4e21f.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-f4f5ed0a.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-bce9de26.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-7a5c3cfd.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-b40e6a7b.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-997eb944.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-5fee0385.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-cf24c7f7.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-16b9326c.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-4a7b8143.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-209a65e3.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-f7a4536c.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-80779d0c.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-8d33be08.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-6240a8bf.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-d61575ea.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-7ce229c7.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-c27dd6e4.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-192acc5a.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-380c0d25.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/apple_385x114-4d1b2eb2.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-20991af0.png"
}
, function(e, t, n) {
    "use strict";
    n.r(t),
    t.default = n.p + "assets/images/google_330x114-4e7dfd29.png"
}
])]);
//# sourceMappingURL=http://ent/web-sourcemaps/widget-0-b8c06181fc57.js.map
